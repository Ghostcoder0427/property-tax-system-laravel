...
<head>
    ...
    <title>Property Tax System - Treasurer Dashboard</title>
</head>
    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            <header>
                ...
                <a href="index.html" class="spur-logo"><i class="fas fa-bolt"></i> <span>Treasurer</span></a>
            </header>
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    <a href="http://localhost/property-tax-system/login.php" class="dash-nav-item">
                        ...
                        <div class="col-xl-6">
                            <div class="card spur-card">
                                <div class="card-header">
                                    ...
                                    <div class="spur-card-title"> Tax Collection </div>

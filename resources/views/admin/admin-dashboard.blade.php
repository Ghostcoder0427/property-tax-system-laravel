...
<head>
    ...
    <title>Property Tax System - Admin Dashboard</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
            ...
            <nav class="dash-nav-list">
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        ...
                        <a href="chartjs.html" class="dash-nav-dropdown-item">Real Properties</a>
                        <a href="chartjs.html" class="dash-nav-dropdown-item">Tax Collectibles</a>
                        <a href="chartjs.html" class="dash-nav-dropdown-item">Collected Tax</a>
                    </div>
                </div>
                <div class="dash-nav-dropdown ">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                        <i class="fas fa-cube"></i>Forms</a>
                    <div class="dash-nav-dropdown-menu">
                        <a href="cards.html" class="dash-nav-dropdown-item">Pending Forms</a>
                        <a href="forms.html" class="dash-nav-dropdown-item">Verified Forms</a>
                        <!-- <div class="dash-nav-dropdown ">
                ...
                <div class="tools">
                    ...
                    <div class="dropdown tools-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                            ...
                            <a class="dropdown-item" href="http://localhost/property-tax-system/login.php">Logout</a>
                        </div>
                    </div>
                </div>
            </header>
